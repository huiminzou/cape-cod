...
qk=axes[0,0].quiverkey(Q,0.1,0.45,0.5, r'$0.1m/s$', fontproperties={'weight': 'bold','size':15})
...
qk=axes[0,1].quiverkey(Q,0.1,0.45,0.5, r'$0.1m/s$', fontproperties={'weight': 'bold','size':15})
...
plt.savefig('drifter4_6to7_8xinn',dpi=400,bbox_inches = "tight")
"""
#################################################################################################
